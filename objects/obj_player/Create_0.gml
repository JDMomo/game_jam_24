...
redTintDuration = 60 * room_speed; // 30 seconds in game frames
invertColorDuration = 60 * room_speed; // 40 seconds in game frames
invertControlsDuration = 60 * room_speed; // 50 seconds in game frames
